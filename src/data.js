export const data = {
  ...
  about: {
    philosophy: "결제는 단 한 번의 장애도 사용자의 큰 불편으로 이어지는 도메인입니다. 12년간 대규모 글로벌 서비스인 Samsung Pay의 결제·리워드·로열티 시스템을 설계하고 운영하며, 대용량 트래픽 속에서도 무너지지 않는 백엔드 아키텍처를 만드는 법을 체득했습니다.",
