export const data = {
  ...
  about: {
    philosophy: "레거시 시스템을 안정적으로 운영하되, 항상 미래를 꿈꾸며 개선을 통해 안정적인 시스템을 구축하는 걸 목표로 합니다.",
    summary: "결제는 단 한 번의 장애도 용납되지 않는 도메인입니다. 12년간 수천만 명이 매일 사용하는 Samsung Pay의 결제·리워드·로열티 시스템을 설계하고 운영하며, 대용량 트래픽 속에서도 무너지지 않는 백엔드 아키텍처를 만드는 법을 체득했습니다. 레거시를 MSA로 전환하고, 인프라를 클라우드로 이전하며, 서비스 내 기능을 단독 기능으로 런칭하고, 팀의 개발 생산성을 끌어올리는 것 — 코드를 넘어 시스템 전체를 설계하는 엔지니어입니다."
  },
  techStack: {
